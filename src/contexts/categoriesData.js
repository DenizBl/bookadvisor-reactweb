...
export const MusicIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 19V6l12-2v13" /><circle cx="6" cy="18" r="3" /><circle cx="18" cy="16" r="3" />
  </svg>
);
export const CookingIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2m0 0a7 7 0 017 7v4a7 7 0 01-7 7 7 7 0 01-7-7v-4a7 7 0 017-7z" />
  </svg>
);
...
export const HeartIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21C12 21 4 13.5 4 8a4 4 0 018-2 4 4 0 018 2c0 5.5-8 13-8 13z" />
  </svg>
);
...
export const LightbulbIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 2a7 7 0 00-7 7c0 3.866 3.134 7 7 7s7-3.134 7-7a7 7 0 00-7-7zm0 14v4m-4 0h8" />
  </svg>
);
export const LeafIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 2C7.03 2 2 7.03 2 12c0 5.52 4.48 10 10 10s10-4.48 10-10c0-4.97-5.03-10-10-10z" />
  </svg>
);
...
export const PawIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <circle cx="6" cy="10" r="2" /><circle cx="18" cy="10" r="2" /><circle cx="12" cy="16" r="2" /><circle cx="9" cy="20" r="1.5" /><circle cx="15" cy="20" r="1.5" />
  </svg>
);
export const MapIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 20l-5.447-2.724A2 2 0 013 15.382V5.618a2 2 0 011.553-1.946L9 2m0 0l6 2.724M9 2v18m6-15.276l5.447 2.724A2 2 0 0121 8.618v9.764a2 2 0 01-1.553 1.946L15 22m0 0V4.724" />
  </svg>
);
export const GameIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <rect x="3" y="7" width="18" height="10" rx="2" /><circle cx="7" cy="12" r="1.5" /><circle cx="17" cy="12" r="1.5" />
  </svg>
);
export const FamilyIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <circle cx="8" cy="10" r="3" /><circle cx="16" cy="10" r="3" /><path d="M2 20v-2a6 6 0 0112 0v2" /><path d="M14 20v-2a6 6 0 0112 0v2" />
  </svg>
);
