...
export default function AdminLayout() {
  ...
  const adminSidebarLinks = [
    ...
    { name: 'Kullanıcı Yönetimi', path: '/admin/users', icon: <UserManagementIcon /> },
    { name: 'Kitap Yönetimi', path: '/admin/books', icon: <BookManagementIcon /> },
    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <div className="flex flex-1">
        ...
        <aside className="w-64 bg-gray-800 text-gray-100 p-4 space-y-2 hidden md:block">
          <div className="text-xl font-semibold mb-6 px-2 text-white">Admin Paneli</div>
          <nav>
